...
\todo{wenn das schon so dort steht, könnte sich dem leser die frage stellen, welche probleme man hat, wenn mans nicht macht?}
...
\todo{wenn es kein Snippet gibt, wo die auftaucht, brauchst du die Methode nicht beim Namen nennen, sondern nur erklären, was die macht -> Schauen wie ich das Umschreibe}
...
\todo{hab das gefühl ein ganz ähnlicher satz ist nicht lange her -> Ich sehs nicht xD}
