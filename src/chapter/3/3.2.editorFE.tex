...
\begin{listing}[!ht]
    \inputminted[xleftmargin=20pt,linenos,firstnumber=49]{ts}{listings/3.2/codemirror-options.ts}
...
\begin{listing}[!ht]
    \inputminted[xleftmargin=20pt,linenos]{ts}{listings/3.2/GenerateResult.ts}
...
\begin{listing}[!ht]
    \inputminted[xleftmargin=20pt,linenos]{ts}{listings/3.2/method.ts}
...
In der Generierung mittels fulibWorkflows wird dieser Link erstellt, darin wird die bereitgestellte Methode mittels~\texttt{window.parent.setIndexFromIframe(0);} aufgerufen.
