...
\begin{figure}[h]
    \centering
    \subfloat[\centering Light-Theme]{{\includegraphics[width=4cm]{images/3.2/light-theme} }}
    \qquad
    \subfloat[\centering Dark-Theme]{{\includegraphics[width=4cm]{images/3.2/dark-theme} }}
