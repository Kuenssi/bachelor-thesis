...
begegnen Softwareentwickelnden bei der agilen Softwareentwicklung für eine personalisierte Kundenanwendung häufiger.
...
Hierbei setzen sich Entwickelnde und Domänenexperten zusammen und erarbeiten in einem Workshop die in der Software darzustellenden Arbeitsabläufe.
Sobald eine Anwendung Benutzeroberflächen enthält, benötigt es ebenso Mockups, wodurch die Entwickelnden Vorschläge für eine Benutzeroberfläche
...
Das Ergebnis dieser Arbeit soll alle extrahierten Ziele erfüllen und somit eine Web-Anwendung entwickelt werden,
...
Dabei wird genauer auf die Anwendung der in Kapitel~\ref{ch:grundlagen} erläuterten Technologien eingegangen.
